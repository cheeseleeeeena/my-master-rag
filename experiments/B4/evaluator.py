...
def evaluate(gold, predicted):
    max_answer_f1s = []
    max_evidence_f1s = []
    max_evidence_precisions = []  # New list for precision
    max_evidence_recalls = []  # New list for recall
    ...
    for question_id, references in gold.items():
        ...
        # Updated to handle precision and recall
        evidence_scores_and_indices = [
            (
                paragraph_f1_score(
        ...
        max_score_details[question_id] = {
            ...
            "evidence_precision": max_evidence_precision,  # Added
            "evidence_recall": max_evidence_recall,  # Added
